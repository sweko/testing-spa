...
(function (roleManagement) {
  var roleManager = (function () {
    function roleManager() {
      ...
      this.allContexts = ko.observableArray([]);
      utility.getAllContexts(this.allContexts);

      this.allPermissions = ko.observableArray([]);
      utility.getAllPermissions(this.allPermissions);

      this.maxRank = ko.observable(0);
      this.maxId = ko.observable(0);
      this.roles = ko.observableArray([]);
      utility.getAllRoles(this.roles, this, this.sortRoles);
    }
    return roleManager;
  })();
